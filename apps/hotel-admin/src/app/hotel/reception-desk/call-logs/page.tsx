...
/** Communication section — full hotel-wide voice-call history. The Reception dashboard's "Recent Calls" panel is the same data, capped to the 5 most recent; this page is the uncapped view. */

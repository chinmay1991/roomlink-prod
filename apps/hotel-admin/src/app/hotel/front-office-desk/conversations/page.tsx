...
/** Front Office (formerly Reception PRD) §17 — hotel-wide conversation inbox, unread (unanswered guest message) first. */
        ...
        <ul className="divide-y divide-slate-100">
          {sorted.map((c) => (
            <li key={c.conversation_id}>
              <Link href={`/hotel/front-office-desk/conversations/${c.conversation_id}`} className="flex items-start gap-3 px-5 py-3.5 hover:bg-slate-50">
                <MessageSquareText
